...
<body>
  ...
  <p style="margin-left: 30px">B1. Cara mengatasi perbedaan pendapat </p>
  <p style="margin-left: 30px">B2. Cara menghindari circle yang toxic</p>
  <p style="margin-left: 30px">B3. Cara membedakan teman yang mensupport dan menjatuhkan</p>
  ...
  <br>
  <form method="post" action="proses-pendaftaran.php" class="row g-3">
    <center>
      <table>
        <tr>
          <td>Nama</td>
